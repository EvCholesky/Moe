...
/* FIsBasic(cp) tests whether cp is a basic code point: */
static inline bool FIsBasic(punycode_uint cp) 
	{ return cp < 0x80; }

/* FIsDelimiter(cp) tests whether cp is a delimiter: */
static inline bool FIsDelimiter(punycode_uint cp) 
	{ return cp == delimiter; }
